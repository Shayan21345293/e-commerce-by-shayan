...
import { SanityImageSource } from '@sanity/image-url/lib/types/types';  // Import the correct type for image source

const builder = createImageUrlBuilder(client);

// Define the urlFor function with a more specific type
